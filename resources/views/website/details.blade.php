                            ...
                            <div class="exzoom" id="exzoom">
                                <div class="exzoom_img_box">
                                    <ul class="exzoom_img_ul">
                                        <li>
                                            <img src="dist/images/product-deatils/1-big-mage.jpg" />
                                        </li>
                                        <li>
                                            <img src="dist/images/product-deatils/2-big-image.jpg" />
                                        </li>
                                        <li>
                                            <img src="dist/images/product-deatils/3-big-image.jpg" />
                                        </li>
                                        <li>
                                            <img src="dist/images/product-deatils/4-big-image.jpg" />
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-7 col-12">
                        <div class="product-pricelist">
                            ...
                            <div class="product-pricelist-ratting">
                                <div class="price"><span>$9.99</span> <del>$11.99</del></div>
                                <div class="star">
                                    <ul>
                            ...
                            <p>
                                Disposable Face Masks: 3-Layers Protection, the inner layer is
                                a soft non-woven fabric, which can absorb the moisture from
                                the breath of the wearer. The middle layer is a melt-blown
                                polypropylene filtration layer for better filter out the
                                particles in the air. The outer layer is a water-resistant
                                layer which can block the splashing liquid in the air.
                            </p>
                            <div class="product-pricelist-selector">
                                ...
                                <div class="product-pricelist-selector-quantity">
                                    ...
                                    <div class="wan-spinner wan-spinner-4">
                                        ...
                                        <a href="javascript:void(0)" class="plus"><svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="21.4" height="17.937"
                                                ...
                                                <g id="Truck_Icon" data-name="Truck Icon"
                                                    ...
                                                    <path id="Path_16" data-name="Path 16"
                                                        ...
                                                        transform="translate(-1.185 -7.5)" fill="none"
                                                    ...
                                                    <path id="Path_17" data-name="Path 17"
                                                        ...
                                                        transform="translate(-8.852 -7.5)" fill="none"
                                                        stroke="#335aff" stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="1.4" />
                                                </g>
                                            </svg>
                ...
                <div class="features-wrapper">
                    <div class="features-active">
                        ...
                        <div class="product-item">
                            <div class="product-item-image">
                                <a href="product-details.html">
                                    <img src="dist/images/product/04.jpg" alt="Product Name" class="img-fluid" /></a>
                                <div class="cart-icon">
                                    <a href="#"><i class="far fa-heart"></i></a>
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16.75" height="16.75"
                        ...
                        <div class="product-item">
                            <div class="product-item-image">
                                <a href="product-details.html">
                                    <img src="dist/images/product/02.jpg" alt="Product Name" class="img-fluid" /></a>
                                <div class="cart-icon">
                                    <a href="#"><i class="far fa-heart"></i></a>
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16.75" height="16.75"
