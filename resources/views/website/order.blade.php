                    ...
                    <div class="dashboard-nav">
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <a href="user-dashboard.html">Account settings</a>
                            </li>
                            <li class="list-inline-item">
                                <a href="deliver-info.html">Billing information</a>
                            </li>
                            <li class="list-inline-item">
                            ...
                            <li class="list-inline-item">
                                <a href="account.html" class="mr-0">Log-out</a>
                            </li>
                        </ul>
                    </div>
                    <!-- Dashboard-Nav  End-->
                ...
                <div class="cart-items">
                    ...
                    <div class="body">
                        <div class="item">
                            ...
                            <div class="price"><span>$254.99</span> <del>$499.99</del></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card-price">
                        ...
                        <form action="#">
                            <a href="billing-information.html" class="btn bg-primary" type="submit"
                                style="width: 100%">Checkout Now</a>
                        </form>
                    </div>
                </div>
            </div>
